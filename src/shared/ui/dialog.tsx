    ...
    return (
        <DialogPortal>
            ...
            <DialogPrimitive.Content
                ...
                className={cn(
                    'bg-card text-popover-foreground ring-accent/20 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95 fixed left-1/2 top-1/2 z-50 grid w-full max-w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 gap-4 rounded-2xl p-4 text-sm shadow-sm outline-none ring-1 duration-100 sm:max-w-sm',
                    className,
                )}
                {...props}
            >
